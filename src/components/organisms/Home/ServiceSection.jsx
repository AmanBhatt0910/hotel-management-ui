      ...
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {serviceData.map(service => (
            <div key={service.id} className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center justify-center transition duration-300 transform hover:scale-105">
