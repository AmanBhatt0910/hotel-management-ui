...
const HeroSection = () => {
  return (
    <div className="relative h-screen bg-cover bg-center overflow-hidden" style={{ backgroundImage: "url('/Home/mountain-image.jpg')" }}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4">
        ...
        <div className="flex items-center justify-center mt-8 space-x-4">
          <a href="#amenities" className="text-gray-300 hover:text-white transition duration-300">Gallery</a>
          <span className="text-gray-300">•</span>
          <a href="#dining" className="text-gray-300 hover:text-white transition duration-300">Services</a>
          <span className="text-gray-300">•</span>
          <a href="#gallery" className="text-gray-300 hover:text-white transition duration-300">FAQ</a>
        </div>
      </div>
    </div>
  );
